      ...
      <form className="modal-dialog ProgressStepBox">
        ...
        <div className="content_text">
          <table className="table table-responsive">
            <thead>
              <tr>
                <th style={{'paddingLeft': '20px'}}>Step2</th>
        ...
        <div className="footer_text wizard_form row">
          ...
          <div className="progress_content col-sm-8">
            ...
            <div className="center_text">02 of 05</div>
          </div>

          <div className="col-sm-2 next_button center_text"><button href="#" type="button" className="next btn blue_background" onClick={this.props.nextPage}>Next &#10093;</button></div>
